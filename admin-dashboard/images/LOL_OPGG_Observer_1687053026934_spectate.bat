...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator-consumer.na1.lol.pvp.net:80 OHSyUh+xNqKAspZjE33b9/ueEi9QV4kJ 4686658853 NA1" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
